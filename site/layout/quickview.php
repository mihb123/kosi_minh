    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <div class="col-md-6">
                    <div class="mb-4">
                        <img id="main-image" src="image/<?= $product->getFeaturedImage() ?>"
                            alt="<?= $product->getName() ?>" class="img-fluid rounded" style="height: 530px;">
                    </div>
                    <!-- Thumbnail Images -->
                    <div class="d-flex gap-2">
                        <img src="image/<?= $product->getFeaturedImage() ?>" alt="Thumbnail 1"
                            class="img-thumbnail thumbnail" style="width: 80px; height: 60px;">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <input type="number" class="form-control w-auto me-2" value="1" min="1" max="10"
                            style="width: 80px;">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="#" class="btn btn-outline-secondary btn-sm rounded-circle">
                            <i class="bi bi-facebook" title="Facebook" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-delay='{"show": 100, "hide": 100}'></i></a>
                        <a href="#" class="btn btn-outline-secondary btn-sm rounded-circle">
                            <i class="bi bi-pinterest" title="Pinterest" data-bs-toggle="tooltip"
                                data-bs-placement="top" data-bs-delay='{"show": 100, "hide": 100}'></i></a>
                        <a href="#" class="btn btn-outline-secondary btn-sm rounded-circle">
